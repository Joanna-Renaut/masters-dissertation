...
oscc_ts = ts_onc_data.loc[ts_onc_data[gene_name].isin(oscc_loss[gene_name])][
...
print(oscc_ts_merge)
oscc_ts_merge.to_csv(
    "../tumour-suppressors-oncogenes/tumour-suppressors-oncogenes-csv/"
    "08_squamous cell_pathogenic_LOF_tumour_suppressors.csv",
    index=False,
)
