...
approved_drugs_count.to_csv(
    "../over-under-expression-csv/31_adenocarcinoma_under_exp_approved_count.csv",
    index=False,
)
...
clinical_trial_drugs_count.to_csv(
    "../over-under-expression-csv/31_adenocarcinoma_under_exp_clinical_trial_count.csv",
    index=False,
)
...
repositionable_SSL_drugs_count.to_csv(
    "../over-under-expression-csv/31_adenocarcinoma_under_exp_repositionale_count.csv",
    index=False,
)
...
fig.show()
fig.write_image(
    "../../figures/stacked-bars/adenocarcinoma_under_expressed_SSL_druggability.png",
    width=1920,
    height=1080,
    scale=1,
)
