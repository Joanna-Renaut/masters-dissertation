...
oncogenes = pandas.read_csv(
    "../over-under-expression-csv/23_adenocarcinoma_over_exp_oncogenes.csv",
    header=0,
    sep=",",
)
...
approved_drugs_count.to_csv(
    "../over-under-expression-csv/29_adenocarcinoma_over_exp_approved_count.csv",
    index=False,
)
...
clinical_trial_drugs_count.to_csv(
    "../over-under-expression-csv/29_adenocarcinoma_over_exp_clinical_trial_count.csv",
    index=False,
)
...
repositionable_onco_drugs_count.to_csv(
    "../over-under-expression-csv/29_adenocarcinoma_over_exp_repositionale_count.csv",
    index=False,
)
...
fig.show()
fig.write_image(
    "../../figures/stacked-bars/adenocarcinoma_over_expression_oncogenes_druggability.png",
    width=1920,
    height=1080,
    scale=1,
)
