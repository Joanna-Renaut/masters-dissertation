...
oac_data = pandas.read_csv('../tumour-suppressors-oncogenes/tumour-suppressors-oncogenes-csv/'
                           '07_adenocarcinoma_pathogenic_LOF_tumour_suppressors.csv', header=0, sep=',')
...
SSL_targets.to_csv('../synthetic-lethal-targets/synthetic-lethal-targets-csv/09_adenocarcinoma_SSL_targets.csv',
                   index=False)
