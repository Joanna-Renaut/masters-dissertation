...
"""
Compare pathogenic tumour suppressors from squamous cell to the SLORTH database to find synthetic lethal targets.
Count how many tumour suppressors had SSL targets and how many SSL partners there are.
"""

oac_data = pandas.read_csv('../tumour-suppressors-oncogenes/tumour-suppressors-oncogenes-csv/'
                           '08_squamous cell_pathogenic_LOF_tumour_suppressors.csv', header=0, sep=',')
...
SSL_targets.to_csv('../synthetic-lethal-targets/synthetic-lethal-targets-csv/10_squamous_cell_SSL_targets.csv',
                   index=False)
