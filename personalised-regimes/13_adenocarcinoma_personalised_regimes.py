...
print(ct_final)
ct_final.to_csv(
    "../personalised-regimes/personalised-regimes-csv/13_adenocarcinoma_clinical_trial_final.csv"
)


# # # 3. compare repositionable drugs against adenocarcinoma patients
repositionable_drugs.rename(
...
repositionable_vs_patients = repositionable_drugs.loc[
    repositionable_drugs["Gene Name A"].isin(patients["GENE_NAME"])
...
patients_vs_repositionable = patients.loc[
    patients["GENE_NAME"].isin(repositionable_drugs["Gene Name A"])
][[patient, gene, mutation_aa, mutation]]
# print(patients_vs_approved)
...
repositionable_final.to_csv(
    "../personalised-regimes/personalised-regimes-csv/13_adenocarcinoma_repositionable_final"
    ".csv"
)
