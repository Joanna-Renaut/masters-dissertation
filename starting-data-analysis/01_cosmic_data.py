...
# # # 3. remove duplicates
filtered_data = data[~data['GENE_NAME'].str.contains('(?:ENST\d*)$')]  # ~'does not contain'
print(filtered_data)
filtered_data.to_csv('../00-database-csv/cosmic_data_duplicates_removed.csv', index=False)
