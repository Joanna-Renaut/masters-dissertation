...
# # # 5. get cansar respositionable drugs for oncogenes adenocarcinoma

cansar_onco = pandas.read_csv(
    "../making-drug-databases/cansar-drugs/12_adenocarcinoma_oncogenes_cpat_results.csv",
    header=0,
    sep=",",
)
...
print(cansar_onco)
cansar_onco.to_csv(
    "../00-database-csv/adenocarcinoma_oncogenes_cansar_full.csv", index=False
)
