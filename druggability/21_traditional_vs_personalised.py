...
adenocarcinoma.drop(
    columns=["Repositionable cancer drug - synthetic lethality", "In clinical trial"],
    axis=1,
    inplace=True,
)
...
adenocarcinoma.dropna(
    subset=["Repositionable cancer drug - synthetic lethality"], inplace=True
)
