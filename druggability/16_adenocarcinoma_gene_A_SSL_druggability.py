...
clinical_trial_drugs_count.to_csv(
    "../figures/stacked-bars/stacked-bar-csv/adenocarcinoma_SSL_clinical_trial_count."
    "csv",
    index=False,
)
clinical_trial_drugs_count = pandas.read_csv(
    "../figures/stacked-bars/stacked-bar-csv/adenocarcinoma_SSL_clinical_trial_count.csv",
    header=0,
    sep=",",
)
...
repositionable_SSL_drugs_count.to_csv(
    "../figures/stacked-bars/stacked-bar-csv/adenocarcinoma_repositionable_SSL"
    "_count.csv",
    index=False,
)
repositionable_SSL_drugs_count = pandas.read_csv(
    "../figures/stacked-bars/stacked-bar-csv/adenocarcinoma_"
    "repositionable_SSL_count.csv",
    header=0,
    sep=",",
)
...
fig.show()
fig.write_image(
    "../figures/stacked-bars/adenocarcinoma_gene_A_SSL_druggability.png",
    width=1920,
    height=1080,
    scale=1,
)
