...
clinical_trial_drugs_count.to_csv(
    "../figures/stacked-bars/stacked-bar-csv/squamous_cell_gene_B_SSL_clinical_"
    "trial_count.csv",
    index=False,
)
clinical_trial_drugs_count = pandas.read_csv(
    "../figures/stacked-bars/stacked-bar-csv/squamous_cell_gene_B_SSL_clinical_trial_count.csv",
    header=0,
    sep=",",
)
...
repositionable_SSL_drugs_count.to_csv(
    "../figures/stacked-bars/stacked-bar-csv/squamous_cell_repositionable_gene_B_SSL"
    "_count.csv",
    index=False,
)
...
fig.show()
fig.write_image(
    "../figures/stacked-bars/squamous_cell_gene_B_SSL_druggability.png",
    width=1920,
    height=1080,
    scale=1,
)
