...
SSL_targets = pandas.read_csv(
    "../synthetic-lethal-targets/synthetic-lethal-targets-csv/10_squamous_cell_SSL_targets.csv",
    header=0,
    sep=",",
)
...
repositionable_SSL_drugs.drop(
    columns=["Drug Status", "Gene Name B"], axis=1, inplace=True
)
repositionable_SSL_drugs.rename(
    columns={"Gene Name A": "Gene Name", "Gene Name B": "SSL Partner"}, inplace=True
)
...
clinical_trial_drugs_count.to_csv(
    "../figures/stacked-bars/stacked-bar-csv/squamous_cell_gene_A_SSL_clinical_"
    "trial_count.csv",
    index=False,
)
clinical_trial_drugs_count = pandas.read_csv(
    "../figures/stacked-bars/stacked-bar-csv/squamous_cell_gene_A_SSL_clinical_trial_count.csv",
    header=0,
    sep=",",
)
...
repositionable_SSL_drugs_count.to_csv(
    "../figures/stacked-bars/stacked-bar-csv/squamous_cell_repositionable_gene_A_SSL"
    "_count.csv",
    index=False,
)
repositionable_SSL_drugs_count = pandas.read_csv(
    "../figures/stacked-bars/stacked-bar-csv/squamous_cell_"
    "repositionable_gene_A_SSL_count.csv",
    header=0,
    sep=",",
)
...
fig.show()
fig.write_image(
    "../figures/stacked-bars/squamous_cell_gene_A_SSL_druggability.png",
    width=1920,
    height=1080,
    scale=1,
)
